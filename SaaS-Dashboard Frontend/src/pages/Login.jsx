    ...
    return (
        <div className="flex min-h-screen flex-col bg-linear-to-br from-gray-100 via-blue-100 to-purple-200">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }} className="flex min-h-screen p-4 sm:p-6 lg:p-12 items-center w-full">
                <div className="bg-linear-to-br from-blue-500 to-purple-600 flex md:flex-row rounded-2xl w-full max-w-6xl mx-auto px-0 py-4 md:p-0 shadow-2xl">
                            ...
                            <div >
                                <form onSubmit={handleLogin} className="flex flex-col space-y-4">
                                    ...
                                    <div className="relative">
                                        <input type={show ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Password" className="w-full border transition-all duration-300 bg-gray-50 focus:bg-white border-gray-300 rounded-lg px-4 py-2 focus:scale-[1.02] focus:outline-none focus:ring-1 focus:ring-blue-500" />
