    ...
    return (
        <div className="flex min-h-screen flex-col">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }} className="flex min-h-screen p-4 sm:p-6 lg:p-12 items-center w-full">
                <div className="bg-linear-to-br from-blue-500 to-purple-600 flex flex-col-reverse md:flex-row rounded-2xl w-full max-w-6xl mx-auto p-4 md:p-0">
                    {/* Left side  */}
                    <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }} className="w-full lg:w-1/2 flex self-center sm:items-center justify-center p-6 lg:p-18 bg-white m-4 rounded-2xl">
                        <div className="w-full max-w-sm px-4 lg:px-12">
                            ...
                            <div className="flex flex-col space-y-4">
                                ...
                                <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Password" className="w-full border transition-all duration-300 focus:scale-[1.02] bg-gray-50 focus:bg-white border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-1 focus:ring-blue-500" />
                                ...
                                <motion.button whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} disable={loading} onClick={handleSignup} className="w-full bg-linear-to-r from-blue-500 to-purple-600 py-2 text-white rounded-lg cursor-pointer flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed">
