...
export const Sidebar = ({ user, isOpen, setIsOpen }) => {
  ...
  return (
    <>
      ...
      <div
        className={`w-full max-w-64 h-screen fixed lg:sticky top-0 left-0 z-50 border-r-2 border-gray-700 bg-gray-950 text-white lg:p-4 flex flex-col justify-between shadow-xl transform transition-transform duration-300 ease-in-out ${isOpen ? "translate-x-0" : "-translate-x-full scroll-auto"}
      ...
      >
        ...
        <div className="flex justify-center flex-col space-y-4">
          ...
          <button
            ...
            disabled={loading}
            className="bg-gray-900 w-full mb-4 sm:mb-36 lg:mb-4 px-2 py-2 rounded-lg flex items-center justify-center gap-2 hover:bg-gray-800 cursor-pointer hover:scale-103 transition-all duration-300 active:scale-97 disabled:opacity-50 disabled:cursor-not-allowed"
          >
